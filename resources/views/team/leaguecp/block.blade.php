...
<article>
	<section>
		<div id="league">
            ...
            <li class="on"><a href="{{route('team.league.block',['id'=>$league->id])}}">ブロック選手</a></li>
            ...
            <li></li>
				...
				<div class="order">
					...
					<div class="box">
            {!!Form::open(['url'=>route('team.league.block',['id'=>$league->id]),'method'=>'get','class'=>'row form-inline'])!!}
            ...
            <table>
              <tr>
                ...
                <th style="width: 35%"><a href="?sort=team" style="text-decoration: none; color: white;">チーム名</a></th>
                <th style="width: 20%"><a href="?sort=school_year" style="text-decoration: none; color: white;">学年</a></th>
