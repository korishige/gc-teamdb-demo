...
<div class="x_panel">
	<ol class="breadcrumb">
	  <li><a href="{{route('admin.news.index')}}">内部向けお知らせ編集</a></li>
	  <li class="active">内部向けお知らせ編集</li>
	</ol>
	...
	<div class="x_content">
		<br>
		{!!Form::open(['url'=>route('admin.news.update'),'class'=>'form-horizontal form-label-left'])!!}
