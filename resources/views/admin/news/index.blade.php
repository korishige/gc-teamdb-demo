...
<div class="x_panel">
  <ol class="breadcrumb">
    <a class="btn btn-default" href="{{route('admin.news.create')}}">内部向けお知らせ追加</a>
    <li class="active">内部向けお知らせ一覧</li>
  </ol>
  ...
  <div class="x_content">
    ...
    <table id="blogList" class="table table-striped jambo_table" width="100%" border="0">
      ...
      <tr>
        ...
        <td class="">
          <a href="{{route('admin.news.edit',['id'=>$news->id])}}" class="btn btn-primary btn-xs">編集</a>
          <a href="{{route('admin.news.delete',['id'=>$news->id])}}" class="btn btn-danger btn-xs confirm">削除</a>
        </td>
      </tr>
      @endforeach
      </tbody>
