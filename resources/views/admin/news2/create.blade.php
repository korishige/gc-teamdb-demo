...
<div class="x_panel">
	<ol class="breadcrumb">
	  <li><a href="{{route('admin.news.index')}}">外部向けお知らせ管理</a></li>
	  <li class="active">外部向けお知らせ追加</li>
	</ol>
	...
	<div class="x_content">
		<br>
		{!!Form::open(['url'=>route('admin.news2.store'),'class'=>'form-horizontal form-label-left'])!!}
