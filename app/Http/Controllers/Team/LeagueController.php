...
class LeagueController extends Controller
{
	...
	public function block(Request $req, $id)
	{
		...
		$orderby = '';
		if ($sort == 'school_year') {
			$orderby = 'p.school_year desc, g.id asc, team_name desc';
		} elseif ($sort == 'team') {
			$orderby = 'team_name desc, g.id asc, p.school_year desc';
		} else {
			$orderby = 'g.id asc, team_name desc, p.school_year desc';
		}
